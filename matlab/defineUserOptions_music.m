function userOptions = defineUserOptions_music()
%
...
userOptions.analysisName = 'SearchlightMusic';
...
userOptions.betaPath = [userOptions.rootPath '/data/rev/[[subjectName]]_[[betaIdentifier]]'];% e.g. /imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[betaIdentifier]]
...
userOptions.maskPath = [userOptions.rootPath '/masks/[[subjectName]]/3mm_mask_Ctx_[[maskName]].img'];%'/imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[maskName]].img';
...
%     'LH_AngularGyrus', ...
%     'LH_Caudate', ...
%     'LH_InferiorFrontalGyrus_po', ...
%     'LH_InferiorFrontalGyrus_pt', ...
%     'LH_pMiddleTemporalGyrus', ...
%     'LH_pSuperiorTemporalGyrus', ...
%     'LH_SuperiorParietalLobule', ...
%     'RH_AngularGyrus', ...
%     'RH_Caudate', ...
%     'RH_InferiorFrontalGyrus_po', ...
%     'RH_InferiorFrontalGyrus_pt', ...
%     'RH_pMiddleTemporalGyrus', ...
%     'RH_pSuperiorTemporalGyrus', ...
%     'RH_SuperiorParietalLobule' ...
...
userOptions.structuralsPath = [userOptions.rootPath '/data/MNI152_T1_3mm_brain'];% e.g. /imaging/mb01/lexpro/[[subjectName]]/structurals/
...
[userOptions.conditionLabels{1:84}] = deal(' ');
